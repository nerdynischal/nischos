...
- Added a macOS-inspired nischalOS lock screen with a live date and time, a keyboard-accessible entry control, a 1.2-second progress indicator, and same-tab session persistence.
